...
ENEMY_SPACE_SHIP6 = pygame.image.load(os.path.join("Images", "Enemies", "enemy_ship_6.png" ))
ENEMY_SPACE_SHIP7 = pygame.image.load(os.path.join("Images", "Enemies", "enemy_ship_7.png" ))
...
BIG_ENEMY1 =  pygame.image.load(os.path.join("Images", "Enemies", "Big_enemy.png" ))
BIG_ENEMY2 =  pygame.image.load(os.path.join("Images", "Enemies", "Big_enemy2.png" ))
BIG_ENEMY3 =  pygame.image.load(os.path.join("Images", "Enemies", "Big_enemy3.png" ))
BIG_ENEMY4 =  pygame.image.load(os.path.join("Images", "Enemies", "Big_enemy4.png" ))
BIG_ENEMY5 =  pygame.image.load(os.path.join("Images", "Enemies", "Big_enemy5.png" ))
